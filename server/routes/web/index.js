module.exports = app => {
    ...
    router.get("/news/init", async (req, res) => {
        ...
        const newsTitle = ["6月18日全服不停机更新公告", "6月14日安卓建议更新公告", "匹配机制优化 | 想玩英雄不重位，阵容搭配新体验！", "恭喜eStarPro捧起银龙杯 赛末冲刺惊喜礼不断", "【稷下的邀约】活动公告", "匹配机制优化 | 想玩英雄不重位，阵容搭配新体验！", "夏日新版本“稷下星之队”即将6月上线", "王者荣耀携手两大博物馆 走进稷下学宫", "王者大陆第一学院【稷下】档案", "新英雄爆料 | 鲁班七号发明者-鲁班大师曝光，孙膑形象大升级！", "6月18日全服不停机更新公告", "6月14日安卓建议更新公告", "6月13日体验服停机更新公告", "【已修复】王者大陆的端午宝藏活动页面异常问题说明", "【已修复】部分召唤师登录界面提示帐号异常说明", "恭喜eStarPro捧起银龙杯 赛末冲刺惊喜礼不断", "【稷下的邀约】活动公告", "活力夏日活动周 王者峡谷好礼多", "王者大陆的端午宝藏活动公告", "峡谷庆端午 惊喜礼不断", "【6月15日 再战西安 · 2019年KPL春季赛总决赛重启公告】", "王者荣耀世界冠军杯荣耀来袭，KPL赛区选拔赛谁能突围而出？", "【关于2019年KPL春季赛总决赛门票退换及异地用户现场观赛补贴公告】", "每周一话：eStarPro成为KPL新王，赛场中哪些表现让你记忆犹新？", "高校排行榜挑战接近尾声，最强校队桂冠将花落谁家？"]
    ...
    router.get("/heroes/init", async (req, res) => {
        ...
        for(let cat of rawsData){
            ...
            cat.heroes=cat.heroes.map(hero=>{
                ...
                // hero.avatar=hero.avatar.split("/").pop()
                return hero
            })
            //录入英雄
    ...
    router.get('/articles', async (req, res) => {
        ...
        //select('-xx')表示排除字段xx，select('+xx'),表示查询xx字段
